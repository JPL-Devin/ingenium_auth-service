...
describe('/permissions/{id}', function() {
  describe('get', function() {
    it('should respond with 200 Permission retrieved...', function(done) {
      /*eslint-disable*/
      var schema = {
        "type": "object",
        "properties": {
      ...
      /*eslint-enable*/
      api.get('/permissions/{id PARAM GOES HERE}')
    ...
    it('should respond with 404 Permission not found', function(done) {
      /*eslint-disable*/
      var schema = {
        "required": [
          "message"
