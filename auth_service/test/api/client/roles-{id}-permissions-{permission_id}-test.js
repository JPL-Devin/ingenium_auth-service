...
describe('/roles/{id}/permissions/{permission_id}', function() {
  describe('delete', function() {
    it('should respond with 200 success', function(done) {
      api.del('/roles/{id PARAM GOES HERE}/permissions/{permission_id PARAM GOES HERE}')
    ...
    it('should respond with 404 permission requested for...', function(done) {
      /*eslint-disable*/
      var schema = {
        "required": [
          "message"
  ...
  describe('patch', function() {
    it('should respond with 200 success', function(done) {
      api.patch('/roles/{id PARAM GOES HERE}/permissions/{permission_id PARAM GOES HERE}')
      .set('Authorization', 'Bearer ' + process.env.INGENIUM_AUTH)
      .set('Content-Type', 'application/json')
      .send({
      })
