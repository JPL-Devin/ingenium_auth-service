...
describe('/roles/{id}/users', function() {
  describe('get', function() {
    it('should respond with 200 Success. a list of the...', function(done) {
      /*eslint-disable*/
      var schema = {
        "type": "array",
        "items": {
      ...
      /*eslint-enable*/
      api.get('/roles/{id PARAM GOES HERE}/users')
  ...
  describe('put', function() {
    it('should respond with 200 success. the updated list...', function(done) {
      ...
      /*eslint-enable*/
      api.put('/roles/{id PARAM GOES HERE}/users')
      .set('Authorization', 'Bearer ' + process.env.INGENIUM_AUTH)
      .set('Content-Type', 'application/json')
      .send({
        data: 'DATA GOES HERE'
    ...
    it('should respond with 404 one or more of the userids...', function(done) {
      /*eslint-disable*/
      var schema = {
        "required": [
          "message"
